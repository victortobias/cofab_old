...
// Dados
  ...
  $frasepagamento = "PAGUE AGORA COM PAGSEGURO";
...
echo "Inscrição realizada com sucesso!";
	...
	echo "<h1>Ops, teve algum erro, tente preencher novamente o formulário</h1>";
}
