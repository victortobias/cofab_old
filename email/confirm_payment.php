...
$destinatario->loadById($id);
$chaveqr = $destinatario->getId();
$rawchaveqr = $destinatario->getId();
$chaveqr = hash("md5", $chaveqr);
$chaveqr = hash("sha256", $chaveqr);
$nameqr ='phpqrcode' . DIRECTORY_SEPARATOR . 'generated' . DIRECTORY_SEPARATOR .  'qr' . $rawchaveqr . '.png';

QRcode::png($chaveqr, $nameqr, 'Q', 5, 2);
//no email
$linkqr = '<img src="cid:qrcode">';
//para teste localmente
//$linkqr = '<img src="'.$nameqr.'">';
...
<!--[if mso]></td></tr></table><![endif]-->
  ...
  <div style="line-height:120%;color:#555555;font-family:' . $fontes1 . ', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 10px;"> 
    <div style="line-height:14px;font-family:Montserrat, ' . $fontes2 . ', Tahoma, sans-serif;font-size:12px;color:#555555;text-align:left;"><p style="margin: 0;line-height: 14px;text-align: center;font-size: 12px"><span style="font-size: 14px; line-height: 16px;"><strong>A sua inscrição está completa agora!</strong></span></p></div> 
  </div>
  <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
  ...
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 10px;"><![endif]-->
  <div style="line-height:120%;color:#555555;font-family:' . $fontes1 . ', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 10px;"> 
    <div style="line-height:14px;font-family:Montserrat, ' . $fontes2 . ', Tahoma, sans-serif;font-size:12px;color:#555555;text-align:left;"><p style="margin: 0;line-height: 14px;text-align: center;font-size: 12px"><span style="font-size: 14px; line-height: 16px;"><strong>O seu QRCODE é único e válido somente para você. Você poderá apresentar ele digitalmente(no smartphone/tablet) ou impresso. Caso não consiga ver o QRCODE, informe o número:'.$rawchaveqr.' </strong></span></p></div> 
  </div>
  <!--[if mso]></td></tr></table><![endif]-->
</div>              
...
// Dados
    ...
    $name = $destinatario->getName();
    $rg = $destinatario->getRg();
    $cpf = $destinatario->getCpf();
    $email = $destinatario->getEmail();
    $telephone = $destinatario->getTelephone();
    $city = $destinatario->getCity();
    $state = $destinatario->getState();
    $category = $destinatario->getCategory();
    $profession = $destinatario->getProfession();
    $performance = $destinatario->getPerformance();
...
$mail->AddEmbeddedImage($nameqr, 'qrcode');


//send the message, check for errors
if (!$mail->send()) {
    echo "<h1>Ops, parece que não foi enviado o email, informe o administrador! </h1> Erro:" . $mail->ErrorInfo;
} else {
...
function save_mail($mail)
{
    ...
    echo "<h1>Ops, teve algum erro para enviar o email. Contate o administrador!</h1>";
}
