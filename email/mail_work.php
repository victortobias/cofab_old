...
// Dados
  ...
  if(!isset($_POST['submit_work'])){
    ...
    $linkpagamento = '';
    $frasepagamento = "VOCÊ RECEBERÁ O LINK PARA PAGAMENTO SOMENTE APÓS A SUBMISSÃO DO TRABALHO";
  }
...
//convert HTML into a basic plain-text alternative bodycofab201@
$mail->msgHTML($body);

//Replace the plain text body with one created manually
$mail->AltBody = 'teste se nao abrir';
...
if (!$mail->send()) {
    ...
    //insere no banco
    $inscricao = new Usuario($name, $rg, $cpf, $email, $telephone, $city, $state, $category, $profession, $performance, $submitwork, $hoje);
    $inscricao->insert();
    //Section 2: IMAP
