...
//função para trocar links de pagamento
$dthoje = date('Y-m-d');
$dtset = "2018-06-11";
$trocadt = false;
...
// Dados
    ...
    $name = $user->getName();
    $email = urldecode($user->getEmail());
    $category = $user->getCategory();
    $sbfa = $user->getSbfa();
    $submitwork = $user->getSubmitwork();
    $confirmworkv = $user->getConfirmwork();
    $confirmsbfav = $user->getConfirmsbfa();
    $confirmstudentv = $user->getConfirmstudent();



//filtro de tipo de inscrição

                //nesse caso o inscrito é estudante, não é sbfa e não enviará trabalho
            if(($category == "COFAB Estudante Graduação e Pós Graduação da Fonoaudiologia") and ($confirmstudentv == 1) and ($sbfa == 0 or NULL) and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bfzqxRS"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bkyXL6q"';
                        }}

                //nesse caso o inscrito é estudante e associado
            if(($category == "COFAB Estudante Graduação e Pós Graduação da Fonoaudiologia") and ($confirmstudentv == 1) and ($sbfa == 1) and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bbzqx2l"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bbyXL9n"';
                        }}

                //nesse caso o inscrito é estudante e enviará trabalho
            if(($category == "COFAB Estudante Graduação e Pós Graduação da Fonoaudiologia") and ($confirmstudentv == 1) and ($sbfa == 0 or NULL) and ($submitwork == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bczqxZR"';
            }
                        

                //nesse caso o inscrito é estudante, associado e enviará trabalho
            if(($category == "COFAB Estudante Graduação e Pós Graduação da Fonoaudiologia") and ($confirmstudentv == 1) and ($sbfa == 1) and ($submitwork == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bczqx4l"';
            }
                ...
                //nesse caso o inscrito é profissional, 
            if(($category == "COFAB Profissional Fonoaudiólogo") and ($sbfa == 0 or NULL) and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bdzqx6c"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bjyXMV0"';
                        }}

                //nesse caso o inscrito é somente profissional e associado
            if(($category == "COFAB Profissional Fonoaudiólogo") and ($sbfa == 1) and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/blzqx8d"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bgyXM1q"';
                        }
            }           
                //nesse caso o inscrito é somente profissional e enviará trabalho
            if(($category == "COFAB Profissional Fonoaudiólogo") and ($submitwork == 1)  and ($sbfa == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bkzqx6T"';
            }

                //nesse caso o inscrito é somente profissional, associado e enviará trabalho
            if(($category == "COFAB Profissional Fonoaudiólogo") and ($submitwork == 1) and ($sbfa == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bkzqyc1"';
            }


                //PROFISSIONAIS OUTRAS AREAS
                //nesse caso o inscrito enviará trabalho
            if(($category == "COFAB Profissional de outras áreas") and ($submitwork == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bkzqyfV"';
            }

                //nesse caso o inscrito não enviará trabalho
            if(($category == "COFAB Profissional de outras áreas") and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bczqygy"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bhyXMvJ"';
                        }}

                //ESTUDANTES DE OUTRAS ÁREAS
                //nesse caso o inscrito enviará trabalho
            if(($category == "COFAB Estudantes Graduação e Pós Graduação de Outras Áreas") and ($confirmstudentv == 1) and ($submitwork == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bbzqyjr"';
            }

                //nesse caso o inscrito não enviará trabalho
            if(($category == "COFAB Estudantes Graduação e Pós Graduação de Outras Áreas") and ($confirmstudentv == 1) and ($submitwork == 0)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bdzqyj1"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bcyXMyd"';
                        }}

                //SIMPÓSIO ESTUDANTE
                //nesse caso o inscrito não enviará trabalho
            if(($category == "Simpósio de Saúde Coletiva Estudantes Graduação e Pós Graduação") and ($confirmstudentv == 1)){
                        $frasepagamento = "PAGAR AGORA COM PAGSEGURO";
                        $linkpagamento = 'href="https://pag.ae/bczqypK"';
                        if($trocadt == true){
                          $linkpagamento = 'href="https://pag.ae/bjyXMCY"';
                        }}
...
if (!$mail->send()) {
    echo "<h1>Ops, parece que teve algum erro ao enviar o LINK de PAGAMENTO! Contate o administrador do sistema. </h1><br> Erro:" . $mail->ErrorInfo;
    //salva erro ao enviar em um log
    $file = fopen("log.txt", "a+");
    fwrite($file, date("d-m-Y H:i:s"). " - " . $mail->ErrorInfo . " IP:" . $_SERVER["REMOTE_ADDR"] . "\r\n");
    fclose($file);
    echo "<br><strong>Erro salvo no Log.</strong>";
} else {
    echo "<h1>E-mail enviado ao cliente!</h1>";
    echo '<a href="../user.php?id=' . $id . '"> Voltar </a>';
...
function save_mail($mail)
{
    ...
    echo "<h1>Ops, teve algum erro ao enviar o LINK DE PAGAMENTO. Contate o administrador!</h1>";
